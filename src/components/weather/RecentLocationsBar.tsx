  ...
  return (
    <AnimatePresence>
      ...
      >
          ...
          {locations.map((loc) => (
            <button
              ...
              className="
                ...
                hover:bg-blue-50/60 shadow-sm transition-all
        ...
        <button
          onClick={onClear}
          className="size-6 rounded-full flex items-center justify-center text-slate-300 hover:text-slate-500 hover:bg-slate-100 transition-colors shrink-0"
